...
- `documents/pr-review-skill.md` is the reference for the PR-review skill and is
  shared by both retry loops (the `/dmail` loop and the issue-driven autonomous
  loop's `ai-review.yml`).
