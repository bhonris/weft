...
describe('createWeftApi', () => {
  ...
  it('routes every remaining bridge method to its channel', async () => {
    ...
    await api.getGitStatus('C:/p')
    await api.stageFiles('C:/p', ['C:/p/a'])
    await api.unstageFiles('C:/p', ['C:/p/a'])
    await api.discardChanges('C:/p', ['C:/p/a'], true)
    await api.gitCommit('C:/p', 'msg')
    ...
    expect(invoke).toHaveBeenCalledWith(CH.getGitStatus, 'C:/p')
    expect(invoke).toHaveBeenCalledWith(CH.stageFiles, 'C:/p', ['C:/p/a'])
    expect(invoke).toHaveBeenCalledWith(CH.unstageFiles, 'C:/p', ['C:/p/a'])
    expect(invoke).toHaveBeenCalledWith(CH.discardChanges, 'C:/p', ['C:/p/a'], true)
    expect(invoke).toHaveBeenCalledWith(CH.gitCommit, 'C:/p', 'msg')
